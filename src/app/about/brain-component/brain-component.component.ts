...
import { Wireframe } from 'src/helpers/Brains/Brain';

@Component({
    selector: 'app-brain-component',
    templateUrl: './brain-component.component.html',
    styleUrls: ['./brain-component.component.scss']
})
